...
const ContactPage = () => {
  ...
  return (
    <section className="text-white bg-[#151615] w-full gap-3 lg:gap-5 p-3 lg:p-6 h-[100vh] lg:h-full lg:w-[450px] flex flex-col items-center pt-[90px] lg:pt-5 lg:mt-0 lg:overflow-hidden overflow-scroll">
